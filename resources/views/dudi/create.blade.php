<x-mainTemplate>
    <div class="container mx-auto px-6 py-8">
        <div class="bg-[#f9fafb] rounded-lg p-6 shadow-md">
            <h1 class="text-3xl font-bold text-[#2d3748] mb-6">Tambah DUDI</h1>
            <form action="{{ route('dudi.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="lokasi" name="lokasi" class="w-full border border-gray-300 rounded-lg p-2" required>
                </div>
                <div class="mb-4">
